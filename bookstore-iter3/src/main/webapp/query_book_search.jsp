...
<body>
  ...
  <s:else>
    <h1 style="text-align: center; color: red; font-size:32px">未找到与<s:property value="title"/>相关的书籍</h1>
    <br/><br/><br/><br/>
  </s:else>
  <form method="post" action="">
    <p style="text-align:center">
      <input type="text" name="title" placeholder="请输入书名" style="width:512px">
